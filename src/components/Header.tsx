    ...
    <header className="fixed top-0 left-0 right-0 z-50 my-[0px] m-[0px]">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 my-[30px] py-[40px] mx-[0px] px-[0px] py-[30px]">
          {/* Left: INK Balance (only when authenticated) */}
          <div className="flex-1">
            {isAuthenticated && (
              <InkBalancePill onNavigate={onNavigate} />
            )}
          </div>
            ...
            {isAdmin && (
              <button
                ...
                style={{
                  ...
                  boxShadow: '0 4px 12px rgba(87, 241, 214, 0.4)',
                }}
                title="Admin Dashboard"
              >
                <Crown size={28} className="text-[#57f1d6]" />
                <div 
